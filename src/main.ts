...
async function bootstrap() {
  ...
  try {
    ...
    logger.info(`ℹCreando instancia del módulo ShippingAppModule...`);
    const app = await NestFactory.create(ShippingAppModule, {
    ...
    const swaggerPath = setupSwagger(
      ...
      "API completa para gestión de Shippings con documentación automática",
      "1.0"
    );
