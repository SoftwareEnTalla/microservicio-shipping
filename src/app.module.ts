...
import { ShippingCommandController } from "./modules/shipping/controllers/shippingcommand.controller";
import { ShippingModule } from "./modules/shipping/modules/shipping.module";
import { CqrsModule } from "@nestjs/cqrs";
import { AppDataSource, initializeDatabase } from "./data-source";
import { ShippingQueryController } from "./modules/shipping/controllers/shippingquery.controller";
import { GraphQLModule } from "@nestjs/graphql";
import { ApolloDriver, ApolloDriverConfig } from "@nestjs/apollo";
import GraphQLJSON from "graphql-type-json";
import { ShippingCommandService } from "./modules/shipping/services/shippingcommand.service";
import { ShippingQueryService } from "./modules/shipping/services/shippingquery.service";
import { CacheModule } from "@nestjs/cache-manager";
import { LoggingModule } from "./modules/shipping/modules/logger.module";
...
@Module({
  imports: [
    ...
    /**
     * Módulos Shipping de la aplicación
     */
    CqrsModule,
    HorizontalModule,
    ShippingModule,
  ...
  /**
   * Controladores de Shipping
   *
   * Registro de controladores a nivel de aplicación.
   */
  controllers: [
  //No se recomienda habilitar los controladores si ya fueron declarados en el módulo: ShippingModule
  /*
  
  ShippingCommandController, 
  ShippingQueryController
  
  */
  ],

  /**
   * Proveedores (Servicios, Repositorios, etc.) de Shipping
   *
   ...
   */
  exports: [ShippingCommandService, ShippingQueryService,LoggerService],
})
export class ShippingAppModule implements OnModuleInit {
  /**
